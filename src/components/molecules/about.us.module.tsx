        ...
        <div className="h-full grid grid-cols-1 md:grid-cols-2 gap-8 p-10">
          ...
          <div>
            ...
            <p className="text-justify text-white">
              Salma’s Beauty didirikan dengan visi untuk menghadirkan produk
              ...
              pengalaman belanja yang terpercaya dan nyaman, Salma’s Beauty
              terus berkembang, membangun jaringan dengan merek-merek global,
              serta menghadirkan produk yang telah teruji kualitasnya. Seiring
              waktu, perusahaan ini memperluas kategorinya, mulai dari skincare
              yang diformulasikan untuk berbagai jenis kulit hingga produk
              makeup yang membantu setiap individu mengekspresikan kecantikan
              mereka. Dedikasi terhadap keaslian produk, layanan pelanggan yang
              unggul, serta pemahaman mendalam terhadap tren kecantikan
              menjadikan Salma’s Beauty sebagai pilihan utama bagi mereka yang
              menginginkan produk terbaik di industri kecantikan. Hingga kini,
              perusahaan terus berkembang dengan memperluas jangkauan dan
              meningkatkan layanan, memastikan setiap pelanggan mendapatkan
              produk berkualitas dengan pengalaman belanja yang eksklusif.
            </p>
          </div>
        </div>
{/* //------- */}
            ...
            <div className="flex flex-col gap-8 items-start">
              <div className="flex items-start gap-4">
                <div>
                  ...
                  Menjadi destinasi utama bagi pecinta kecantikan dengan menyediakan berbagai produk makeup dan skincare dari brand-brand ternama, memastikan kualitas terbaik, dan menghadirkan pengalaman berbelanja yang terpercaya serta menyenangkan.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
